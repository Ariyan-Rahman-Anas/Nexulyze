...
export function ActivityCreatePanel({
  ...
  return (
    <Drawer open={open} onOpenChange={onOpenChange} direction="right">
        <DrawerContent className="h-full max-w-lg ml-auto mr-0 mt-0 rounded-l-lg rounded-r-none border-l border-t-0 border-r-0 border-b-0 fixed right-0 top-0 data-[state=open]:animate-slide-in-from-right data-[state=closed]:animate-slide-out-to-right">
